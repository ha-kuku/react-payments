...
padding: 15px 20px;
`;
const StyledIconWrap = dt.div`
display: flex;
flex-direction: row;
justify-content: space-between;
width: 100%;
height: 30px;`;
const StyledMagnetic = dt.div`
width: 100%;
max-width: 50px;
height: 30px;
border-radius: 6px;
background-color: #DDCD78;`;
const StyledLogoWrap = dt.div`
width: 100%;
max-width: 50px;
height: 30px;
border-radius: 6px;
...
`;
const StyledCardNumberWrap = dt.div`
display: flex;
flex-direction: row;
align-items: center;
width: 100%;
...
letter-spacing: 16%;
color: #FFFFFF;`;
const StyledExpirationPeriod = dt.div`
width: 100%;
font-size: 25px;
font-weight: 500;
letter-spacing: 16%;
...
function CardPreview({ cardNumber, expirationPeriod }) {
  const [logoSrc, setLogoSrc] = reactExports.useState(INITIALIZE_VALUE);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(StyledContainer$5, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(StyledIconWrap, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(StyledMagnetic, {}),
      logoSrc !== INITIALIZE_VALUE ? /* @__PURE__ */ jsxRuntimeExports.jsx(StyledLogoWrap, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: logoSrc, alt: "logo", style: { width: "100%", height: "100%" } }) }) : null
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(StyledCardNumberWrap, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(StyledCardNumber, { children: cardNumber["second"] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StyledCardNumber, { children: "*".repeat(cardNumber["third"].length) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StyledCardNumber, { children: "*".repeat(cardNumber["fourth"].length) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(StyledExpirationPeriod, { children: [
...
const StyledContainer$4 = dt.div`
display: flex;
flex-direction: column;
align-items: flex-start;
gap: 4px;
`;
const StyledTitle = dt.h1`
font-size : 18px;
font-weight : 700;
margin : 0;
`;
const StyledSubTitle = dt.p`
font-size : 9.5px;
font-weight : 400;
color : #8B95A1;
margin : 0;
...
function SectionTitle({ title, subTitle }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(StyledContainer$4, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(StyledTitle, { children: title }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(StyledSubTitle, { children: subTitle })
  ] });
}
...
`;
function Input({ width, maxLength, placeholder, onChange, value, isError }) {
...
const isValidLength = (number, maxLength) => {
...
const isValidMonthRange = (number) => {
  if (Number(number) <= 12 && Number(number) >= 1) {
    return true;
  }
  return false;
};
const isValidYearRange = (number) => {
...
const StyledContainer$3 = dt.div`
    ...
    width: 100%;
`;
const StyledInputWrap = dt.div`
    display: flex;
    align-items: center;
    gap: 10px;
    align-self: stretch;
`;
const StyledErrorMessage = dt.p`
    color: red;
    font-size: 12px;
    margin: 0;
`;
...
function CardNumberInputs({ cardNumber, changeCardNumber }) {
  ...
  function checkValidation(position2, length2, number) {
    if (number === NO_ERROR) {
      setError((prev2) => {
        prev2[position2] = NO_ERROR;
        return { ...prev2 };
      });
      return;
    }
    if (!isValidLength(number, length2)) {
      setError((prev2) => {
        prev2[position2] = errorMessage$2.length;
        return { ...prev2 };
      });
      return;
    } else if (!isValidNumber(number)) {
      setError((prev2) => {
        prev2[position2] = errorMessage$2.number;
        return { ...prev2 };
      });
      return;
    }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(StyledContainer$3, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "", children: "카드 번호" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(StyledInputWrap, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Input,
        {
          ...
          onChange: (e) => {
            ...
            changeCardNumber("first", (_a = e.target) == null ? void 0 : _a.value);
          },
          width: "25%",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Input,
        {
          ...
          onChange: (e) => {
            ...
            changeCardNumber("second", (_a = e.target) == null ? void 0 : _a.value);
          },
          width: "25%",
          maxLength: CARD_NUMBER_LENGTH,
          placeholder: "1234",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Input,
        {
          ...
          onChange: (e) => {
            ...
            changeCardNumber("third", (_a = e.target) == null ? void 0 : _a.value);
          },
          width: "25%",
          maxLength: CARD_NUMBER_LENGTH,
          placeholder: "1234",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Input,
        {
          ...
          onChange: (e) => {
            ...
            changeCardNumber("fourth", (_a = e.target) == null ? void 0 : _a.value);
          },
          width: "25%",
          maxLength: CARD_NUMBER_LENGTH,
          placeholder: "1234",
    ...
    getErrorMessage() ? /* @__PURE__ */ jsxRuntimeExports.jsx(StyledErrorMessage, { children: getErrorMessage() }) : null
  ] });
}
const StyledContainer$2 = dt.div`
    display: flex;
    flex-direction: column;
    justify-content: center;
    align-items: flex-start;
    gap: 16px;
`;
function CardNumberSection({ cardNumber, changeCardNumber }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(StyledContainer$2, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SectionTitle, { title: "결제할 카드 번호를 입력해 주세요", subTitle: "본인 명의의 카드만 결제 가능합니다." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardNumberInputs, { cardNumber, changeCardNumber })
  ] });
}
...
function CardExpirationPeriodInputs({ expirationPeriod, changeExpirationPeriod }) {
  const [error, setError] = reactExports.useState({
    month: NO_ERROR,
    year: NO_ERROR
  });
  function checkCommonValidation(expirationPeriod2, length2, number) {
    if (!isValidLength(number, length2)) {
      setError((prev2) => {
        prev2[expirationPeriod2] = errorMessage$1.length;
        return { ...prev2 };
      });
      return;
    }
    if (!isValidNumber(number)) {
      setError((prev2) => {
        prev2[expirationPeriod2] = errorMessage$1.number;
        return { ...prev2 };
      });
      return;
    }
    setError((prev2) => {
      prev2[expirationPeriod2] = NO_ERROR;
      return { ...prev2 };
    });
  }
  function checkMonthValidation(length2, number) {
    if (number === NO_ERROR) {
      setError((prev2) => {
        prev2[EXPIRATION_PERIOD.MONTH] = NO_ERROR;
        return { ...prev2 };
      });
      return;
    }
    if (!isValidMonthRange(number)) {
      setError((prev2) => {
        prev2[EXPIRATION_PERIOD.MONTH] = errorMessage$1.monthRange;
        return { ...prev2 };
      });
      return;
    }
    checkCommonValidation(EXPIRATION_PERIOD.MONTH, length2, number);
  }
  function checkYearValidation(length2, number) {
    if (number === NO_ERROR) {
      setError((prev2) => {
        prev2[EXPIRATION_PERIOD.YEAR] = NO_ERROR;
        return { ...prev2 };
      });
      return;
    }
    if (!isValidYearRange(number)) {
      setError((prev2) => {
        prev2[EXPIRATION_PERIOD.YEAR] = errorMessage$1.yearRange;
        return { ...prev2 };
      });
      return;
    }
    checkCommonValidation(EXPIRATION_PERIOD.YEAR, length2, number);
  }
  function getErrorMessage() {
    for (const key in error) {
      const typedKey = key;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(StyledContainer$3, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "", children: "유효 기간" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(StyledInputWrap, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Input,
        {
...
const StyledContainer$1 = dt.div`
    ...
    width: 100%;
`;
function CardExpirationPeriodSection({ expirationPeriod, changeExpirationPeriod }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(StyledContainer$1, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SectionTitle, { title: "카드 유효기간을 입력해 주세요", subTitle: "월/년도(MMYY)를 순서대로 입력해 주세요." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardExpirationPeriodInputs, { expirationPeriod, changeExpirationPeriod })
  ] });
}
...
function CardCVCNumberInputs({ CVCNumber, changeCVCNumber }) {
  const [error, setError] = reactExports.useState(NO_ERROR);
  function checkValidation(length2, CVCNumber2) {
    if (CVCNumber2 === NO_ERROR) {
      setError(NO_ERROR);
      return;
    }
    if (!isValidLength(CVCNumber2, length2)) {
      setError(errorMessage.length);
      return;
    }
    if (!isValidNumber(CVCNumber2)) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(StyledContainer$3, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "", children: "CVC" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(StyledInputWrap, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      Input,
      {
        value: CVCNumber,
        onChange: (e) => {
    ...
    error !== NO_ERROR ? /* @__PURE__ */ jsxRuntimeExports.jsx(StyledErrorMessage, { children: error }) : null
  ] });
}
const StyledContainer = dt.div`
    ...
    width: 100%;
`;
function CardCVCNumberSection({ CVCNumber, changeCVCNumber }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(StyledContainer, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SectionTitle, { title: "CVC 번호를 입력해 주세요" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardCVCNumberInputs, { CVCNumber, changeCVCNumber })
  ] });
}
const StyledApp = dt.div`
display: flex;
justify-content : center;
`;
const StyledFrame = dt.div`
display: inline-flex;
...
function App() {
  ...
  const [CVCNumber, setCVCNumber] = reactExports.useState(INITIALIZE_VALUE);
  function changeCardNumber(position2, cardNumber2) {
    setCardNumber((prev2) => {
      prev2[position2] = cardNumber2;
      return { ...prev2 };
    });
  }
  function changeExpirationPeriod(expirationPeriod2, date) {
    setExpirationPeriod((prev2) => {
      prev2[expirationPeriod2] = date;
      return { ...prev2 };
    });
  }
  function changeCVCNumber(CVCNumber2) {
    setCVCNumber(CVCNumber2);
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx(StyledApp, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(StyledFrame, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardPreview, { cardNumber, expirationPeriod }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardNumberSection, { cardNumber, changeCardNumber }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardExpirationPeriodSection, { expirationPeriod, changeExpirationPeriod }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardCVCNumberSection, { CVCNumber, changeCVCNumber })
  ] }) });
}
